...
def pddlstream_from_problem(problem, collisions=True, **kwargs):
    ...
    stream_map = {
        ...
        'inv-image': from_gen_fn(get_inv_vis_gen(problem, custom_limits=custom_limits,
                                                 collisions=collisions,  **kwargs)),
        'inv-transmit': from_gen_fn(get_inv_com_gen(problem, custom_limits=custom_limits,
                                                    collisions=collisions, **kwargs)),
...
def main():
    ...
    stream_info = {
        ...
        'inv-image': StreamInfo(),
        'inv-transmit': StreamInfo(),
