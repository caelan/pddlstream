...
def solve_execution(initial_problem, stream_info={}, unit_costs=False, unit_efforts=False, verbose=True, **kwargs):
    ...
    # No real need to save streams because we use generator functions
    #static_init, fluent_init = partition_facts(domain, init)
